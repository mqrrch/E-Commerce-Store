    ...
    return(
        ...
        >
            ...
            <p className="text-sm text-center mt-1">
                Dont have an account? Click <Link to='/register' className="text-green-500 transition-colors duration-100 hover:text-green-600">here</Link>
            </p>
            ...
            <button type="submit" className="p-2 text-center border-1 border-green-400 hover:bg-green-200 cursor-pointer rounded-xl mt-4 transition-colors duration-300">
                <p className="text-green-600 font-bold">Log In</p>
            </button>
        </form>
    )
}